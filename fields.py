...
#grak
def tum():
    print("Հովհաննես Թումանյանի հետ կապված հարցերն են՝ \n1.Ներկայացնել նրա կյանքը \n2.Ներկայացնել նրա ստեղծագործությունները \n3.Ինչպե՞ս է նա ստացել «Ամենայն Հայոց Բանաստեղծ» անունը \n4.Ներկայացնել նրա դերը գրականության մեջ \n5.Ներկայացնել նրա թարգմանչական գործը")
    question = input("Գրեք, թե ինչ հարց ունեք = ")
    question = question.lower()
    if "կյան" in question:
        literature.tum_life()
...
def abov():
    print("Խաչատուր Աբովյանի հետ կապված հարցերն են՝ \n1.Ներկայացնել նրա կյանքը \n2.Ներկայացնել նրա ստեղծագործությունները \n3.Ներկայացնել նրա դերը գրականության մեջ \n4.Ներկայացնել նրա անհետացման հետ կապված վարկածները \n5.Ներկայացնել նրա «Վերք Հայաստանի» պատմավեպը")
    question = input("Գրեք, թե ինչ հարց ունեք = ")
    question = question.lower()
    if "կյան" in question:
...
def mash():
    print("Մեսրոպ Մաշտոցի հետ կապված հարցերն են՝ \n1.Ներկայացնել նրա կյանքը \n2.Ներկայացնել հայ գրերի գյուտը \n3.Ներկայացնել նրա ստեղծագործությունները \n4.Ներկայացնել այլ ազգերի գրերի գյուտը")
    question = input("Գրեք, թե ինչ հարց ունեք = ")
    question = question.lower()
    if "կյան" in question:
...
def nar():
    print("Գրիգոր Նարեկացու հետ կապված հարցերն են՝ \n1.Ներկայացնել նրա կյանքը \n2.Ներկայացնել նրա ստեղծագործությունները \n3.Ներկայացնել նրա «Մատյան ողբերգության» կամ «Նարեկ» գիրքը \n4.Ներկայացնել նրա հոգևոր կյանքը")
    question = input("Գրեք, թե ինչ հարց ունեք = ")
    question = question.lower()
...
def sn():
    print("Սայաթ Նովայի հետ կապված հարցերն են՝ \n1.Ներկայացնել նրա կյանքը \n2.Ներկայացնել նրա ստեղծագորգությունները \n3.Ի՞նչ վեճեր են գնում նրա հետ կապված \n4.Ներկայացնել նրա խաղերը")
    question = input("Գրեք, թե ինչ հարց ունեք = ")
    question = question.lower()
    if "կյան" in question:
        literature.sn_life()
