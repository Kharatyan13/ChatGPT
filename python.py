...
def list1():
    print("""
    Python-ում list-ը (ցանկը) փոփոխելի տվյալների տիպ է, որը թույլ է տալիս միևնույն փոփոխականի մեջ պահել բազմաթիվ արժեքներ։ Այն կարող է պարունակել տարբեր տիպի տվյալներ՝ թվեր, տողեր, այլ ցուցակներ և այլն։
